...
def update_contact():
    ...
    if selected_contact:
        ...
        messagebox.showerror("Error",
                             "Пожалуйста, выберите контакт для обновления.")
...
def delete_contact():
    ...
    if selected_contact:
        ...
        messagebox.showerror("Error",
                             "Пожалуйста, выберите контакт для удаления.")
...
update_button = tk.Button(root, text="Редактировать", command=update_contact)
...
contacts_scroll = ttk.Scrollbar(contacts_frame, orient=tk.VERTICAL,
                                command=contacts_tree.yview)
